...
static const int SPIKEBALL_ID = 8;
static const int POINT_SPHERE_ID = 9;
static const int POWER1_ID = 10;
static const int POWER2_ID = 11;
static const int POWER3_ID = 12;